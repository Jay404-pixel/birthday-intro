document.addEventListener('DOMContentLoaded', () => {
  ...
  const journeyMilestones = [
    ...
    { id:2,  title:'Our First Coffee Together', date:'20 March 2022',    emoji:'☕', image:'./timeline/img2.jpeg',  description:'Hours turned into minutes when we were together. That little café became sacred ground — the place where we first truly laughed.' },
    { id:3,  title:'The Late Night Call',       date:'5 April 2022',     emoji:'🌙', image:'./timeline/img3.jpeg',  description:'We talked until 3am and forgot the time entirely. That night, I realised talking to you was my favourite thing in the world.' },
    { id:4,  title:'Dancing in the Rain',       date:'18 April 2022',    emoji:'🎵', image:'./timeline/img4.jpeg',  description:'The skies opened and instead of running, we danced. Soaked and laughing, we made magic out of an ordinary Tuesday.' },
    { id:5,  title:'The Beach at Sunset',       date:'1 May 2022',       emoji:'🌊', image:'./timeline/img5.jpeg',  description:'Sitting at the edge of the world as the sun melted into the sea. You said something beautiful. I never forgot it.' },
    { id:6,  title:'Picnic in the Park',        date:'15 May 2022',      emoji:'🧺', image:'./timeline/img6.jpeg',  description:'Sandwiches, lemonade, and you — the most perfect afternoon I can remember. Every bite tasted better with your laughter nearby.' },
    { id:7,  title:'Movie Night Marathons',     date:'30 May 2022',      emoji:'🍿', image:'./timeline/img7.jpeg',  description:'We argued about which film to watch and fell asleep through all of them. Best movie nights ever — zero movies actually watched.' },
    { id:8,  title:'Autumn Walk Together',      date:'10 October 2022',  emoji:'🍂', image:'./timeline/img8.jpeg',  description:'Crunching leaves underfoot, warm scarves, and your hand in mine. Some moments feel like they were designed just for us.' },
    { id:9,  title:'Our First Road Trip',       date:'25 October 2022',  emoji:'🚗', image:'./timeline/img9.jpeg',  description:'We got lost twice, found a hidden café once, and sang every song on the radio. Probably the best wrong turn we ever made.' },
    { id:10, title:'First Birthday Together',   date:'15 November 2022', emoji:'🎂', image:'./timeline/img10.jpeg', description:`You baked a lopsided cake and it was the most perfect thing I've ever tasted. Your smile that day — I keep it in my heart always.` },
    { id:11, title:'Christmas Eve Magic',       date:'24 December 2022', emoji:'🎄', image:'./timeline/img11.jpeg', description:'Warm lights, hot chocolate, and the kind of evening that feels like a scene from a beautiful film. You made it feel like a dream.' },
    { id:12, title:"New Year's Together",       date:'1 January 2023',   emoji:'🎆', image:'./timeline/img12.jpeg', description:'As the fireworks lit up the sky, I made a secret wish — that every new year begins exactly like this one. With you.' },
    { id:13, title:'Spontaneous Cooking Night', date:'14 February 2023', emoji:'🍝', image:'./timeline/img13.jpeg', description:'We tried to cook pasta from scratch. It was a disaster. We ordered pizza in the end and laughed the whole night. Perfection.' },
    { id:14, title:'Stargazing Night',          date:'20 March 2023',    emoji:'⭐', image:'./timeline/img14.jpeg', description:`Lying on a blanket beneath a million stars, you pointed at the sky and said "That one's mine." I said, "Then you already have the brightest one."` },
    { id:15, title:'The Concert',               date:'8 April 2023',     emoji:'🎶', image:'./timeline/img15.jpeg', description:'You sang every word of every song. Watching you lose yourself in the music was better than the music itself. You were the show.' },
    { id:16, title:'Rainy Day at Home',         date:'3 June 2023',      emoji:'🌧️', image:'./timeline/img16.jpeg', description:'No plans, nowhere to be, just you and a rainy window. Some of the best days look like nothing on paper and everything in memory.' },
    { id:17, title:'Our Favourite Restaurant',  date:'20 August 2023',   emoji:'🍽️', image:'./timeline/img17.jpeg', description:'We went back to the place we had our first real dinner. Same booth, same menu — but everything felt richer this time. Because we were more us.' },
    { id:18, title:'The Surprise I Planned',    date:'10 October 2023',  emoji:'🎁', image:'./timeline/img18.jpeg', description:'I had been planning it for weeks. The look on your face when you walked in made every second worth it ten times over.' },
    { id:19, title:'Sunrise at the Hill',       date:'1 January 2024',   emoji:'🌅', image:'./timeline/img19.jpeg', description:'We woke up early and climbed to watch the first light of the new year. Cold air, warm coffee, and you beside me. What a way to begin.' },
    { id:20, title:'Today — Your Birthday ❤️', date:'Right Now',        emoji:'🎉', image:'./timeline/img20.jpeg', description:`Every moment on this road has led to today. Happy Birthday, Angela. You are the most beautiful chapter of my life — and we're only just getting started.` }
  ];
